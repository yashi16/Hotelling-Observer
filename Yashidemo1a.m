...
subplot(2,2,2)
J = imnoise(g, 'gaussian',0,v/50);
imshow(J); colormap(gray); axis image; axis xy; axis off; colorbar
title('Gaussian White noise image')





    %J = imnoise([g,s], 'gaussian');
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    g1(:,i) = g(:);
   if i==1,
      figure
